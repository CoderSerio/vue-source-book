...
const ReadingSection: React.FC<ReadingSectionProps> = ({ data }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto flex flex-col justify-center h-full max-h-[90vh]">
      <div className="sketchy-border bg-[#fffdf5] p-8 md:p-12 lg:p-16 relative shadow-[12px_12px_0px_rgba(0,0,0,0.1)] flex flex-col lg:flex-row gap-10 items-center">
        
        {/* Text Content */}
        <div className="flex-1 space-y-6 overflow-y-auto max-h-[60vh] pr-4 scroll-smooth custom-scrollbar">
